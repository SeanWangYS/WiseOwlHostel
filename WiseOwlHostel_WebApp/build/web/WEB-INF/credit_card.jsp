...
<%
    ...
    try {
        ...
        obj.setItemName("智慧貓頭鷹信用卡-"+order.getId()+" "+order.getTotalAmount());
        ...
        obj.setMerchantTradeNo("WOH201904"+ String.format("%011d", order.getId()));        //必須是20個英數字字元，且不得與上次訂單重複
...
//        obj.setRedeem("");
        ...
        obj.setTotalAmount(String.valueOf((int)order.getTotalAmount()));
